...
#define t3_ID 2
const TaskType t3 = t3_ID; 
extern void t3_function(void);

struct AUTOSAR_TCB t3_tcb = {
	NULL, 		// 	struct OsXenomaiTask * xeno_task;
	t3_function,	// 	EcucFunctionParamDef handler;
	SUSPENDED,	// 	TaskStateType state;
	0,		//	EcucIntegerParamDef activation_number;
	t3_RESOURCE_COUNT//	EcucIntegerParamDef resourceCount link to task
};

struct OsTask t3_OsTask = {
...
struct OsAlarmAutostart alarm2_OsAlarmAutostart = {
...
struct OsAlarm alarm2_OsAlarm = {
	...
	&alarm2_OsAlarmAutostart,	//	struct OsAlarmAutostart * OsAlarmAutostart;
	NULL				//	IMPL+ : struct AUTOSAR_ACB * acb;
